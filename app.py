...
st.subheader('Predicted Close Price ' + tick.upper() + ' for next week')
fig5 = plt.figure(figsize=(10,6))
days = range(1, 8)
plt.plot(days, predicted_prices, 'r', label='Predicted Close Price')
plt.title('Predicted ' + tick + ' Prices for the Next Week')
plt.xlabel('Day')
plt.ylabel('Price')
plt.legend()
st.pyplot(fig5)
...
plt.title('Predicted ' + tick + ' Prices for the Next Month')
plt.xlabel('Day')
plt.ylabel('Price')
plt.legend()
st.pyplot(fig6)
